...
<head>
    ...
    <title>Clase Java- DI-NAMO</title>
    <link rel="stylesheet" href="../stilos/global.css">
    <link rel="stylesheet" href="../stilos/clases_java.css">
</head>
    ...
    <main>
        <div id = "1" class="lesson-container">
            <div class="instructions">
                <h2>Lección 1: Inicios en Java</h2>
                <p><strong>Objetivo:</strong> Aprender ¿Qué es Java? y realizar un Hola Mundo.</p>
            </div>
...
<h2>Toma en cuenta:</h2>
                <p>Al terinar cualquier instruccion se debe colocar siempre un punto y coma (;) para indicar que la instrucción termina allí.</p>                
            </div>
        </div>
...
<h2>Toma en cuenta:</h2>
    ...
    <form action="../scripts/prueba_java.php?numero=<?= $numero ?>">
